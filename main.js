...
$("#formPersonas").submit(function(e){
    ...
    $.ajax({
        ...
        type: "POST",
        dataType: "json",
        data: {nombre:nombre, correo:correo, usuario:usuario, password:password, telefono:telefono, estatus:estatus, idEquipo:idEquipo, idPerfil:idPerfil, id:id, opcion:opcion},
        success: function(data){  
            ...
            if(opcion == 1){tablaPersonas.row.add([id,nombre,correo,usuario,password,telefono,estatus,idEquipo,idPerfil]).draw();}
            else{tablaPersonas.row(fila).data([id,nombre,correo,usuario,password,telefono,estatus,idEquipo,idPerfil]).draw();}            
        }        
    });
