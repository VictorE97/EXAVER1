        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div style="float: right; margin-top: -10px; margin-right: 10px">
                    <a href="Part One Ingresar.php"> <button type="button" class="btn btn-warning"><i class="fas fa-pen-square"></i></button></a>
                <?php
                                        //include ('Conexion.php');
                                        $mysqli = new mysqli("localhost", "root", "123456", "exaver");
                                        $sql="select * from exa1_par1";
                                        ...
                                        <a href='Part One Actualizar.php?idPartOne=".$mostrar['idPartOne']."'><button class='btn btn-primary' type='button' data-toggle='modal' data-target='#exampleModal'><i class='fas fa-edit'></i></button></a>

                                        <a href='Eliminar/Eliminar_PartOne.php?idPartOne=".$mostrar['idPartOne']."'> <button type='button' class='btn btn-danger'><i class='far fa-trash-alt'></i></button></a>

                                        </td>";
                                        echo "<tr>";
                                            echo "<td>"; echo "<input type='hidden' name='idPartOne' value='.$mostrar[0].' />"; echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
                </div> <br><br>
                                            ...
                                            <div>
                                                <div class="alert miBordeDoble"><div>
                                                    <div class="form-group">
                                                        <p><b><?php echo $row["instruccion"]; ?></b></p>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-5 col-sm-5 col-md-4 col-lg-4 col-xl-4">
                                    <div>
                                        ...
                                        <div class="" style="width: 313px;height: 110px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(J.jpg);background-size: cover;">
                                            <center>
                                            <div style="float: center; width: 120px; padding: 10px; margin-left: 50px;">
                                                <p><b><?php echo $row["rJ"]; ?></b></p>
                                            </div>
                                            </center>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row EspacioRespuestas">
                                            ...
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4" >
                                                <div class="" style="width: 318px;height: 112px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(A.jpg);background-size: cover;">
                                                    ...
                                                    <div style="float: right; width: 200px; padding: 15px" >
                                                            <?php echo $row["rA"]; ?>
                                                    </div>
                                        ...
                                        <div class="row EspacioRespuestas">
                                            ...
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                                <div class="" style="width: 318px;height: 105px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(B.jpg);background-size: cover;">
                                                    <center>
                                                        <div style="float: right; width: 200px; padding: 8px" >
                                                            <?php echo $row["rB"]; ?>
                                                        </div>
                                                    </center>
                                                </div>
                                        ...
                                        <div class="row EspacioRespuestas">
                                            ...
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                                <div class="" style="width: 318px;height: 105px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(C.jpg);background-size: cover;">
                                                    <center>
                                                        <div style="float: center; width: 120px; padding: 5px;">
                                                            <?php echo $row["rC"]; ?>
                                                        </div>
                                                    </center>
                                                </div>
                                        ...
                                        <div class="row EspacioRespuestas">
                                            ...
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                                <div class="" style="width: 318px;height: 105px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(D.jpg);background-size: cover;"><br>
                                                    <center>
                                                        <div style="float: right; width: 170px; margin-top: -10px; margin-right: 20px;">
                                                            <?php echo $row["rD"]; ?>
                                                        </div>
                                                    </center>
                                                </div>
                                        ...
                                        <div class="row EspacioRespuestas">
                                            ...
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                                <div class="" style="width: 318px;height: 105px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(E.jpg);background-size: cover;">
                                                    <center>
                                                        <div style="width: 200px; margin-left: 50px; padding: 10px;">
                                                            <?php echo $row["rE"]; ?>
                                                        </div>
                                                    </center>
                                                </div>
                                        ...
                                        <div class="row EspacioRespuestas">
                                            ...
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                                <div class="" style="width: 318px;height: 105px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(G.jpg);background-size: cover;">
                                                    <center>
                                                        <div style="width: 180px; margin-left: 60px; padding: 8px;">
                                                            <?php echo $row["rG"]; ?>
                                                        </div>
                                                    </center>
                                                </div>
                                        ...
                                        <div class="row EspacioRespuestas">
                                            ...
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                                <div class="" style="width: 318px;height: 105px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(H.jpg);background-size: cover;">
                                                    <center>
                                                        <div style="width: 150px; margin-left: 50px; padding: 8px;">
                                                            <?php echo $row["rH"]; ?>
                                                        </div>
                                                    </center>
                                                </div>
                                        ...
                                        <div class="row EspacioRespuestas">
                                            ...
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                                <div class="" style="width: 320px;height: 105px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(I.png);background-size: cover;">
                                                    <center>
                                                        <div style="margin-left: 60px; padding: 12px;">
                                                            <?php echo $row["rI"]; ?>
                                                        </div>
                                                    </center>
                                                                                                    </div>
