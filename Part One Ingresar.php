    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <form action="Agregar/Agregar_PartOne.php" method="POST">

                    <div style="margin: 8px">
                        <input type="" name="" style="margin-left: 3px;" placeholder="Escritor de Part One"> 
                        <input type="datetime" name="" style="margin-left: 15px; width: 200px" placeholder="AAAA-MM-DD HH:MM:SS">
                        <select style="margin-left: 15px" name="">
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        </select>
                                ...
                                <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                    <div class="float-right">
                                        ...
                                        <section style="margin-left: 10px; margin-right: 10px">
                                            <div>
                                                <div class="alert miBordeDoble"><div>
                                                    <div class="form-group">
                                                        <textarea class="form-control" id="exampleFormControlTextarea1" name="instruccion" rows="3"></textarea>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                        ...
                        <div class="alert miBordeSencillo" style="margin-left: 10px; margin-right: 10px">
                            <div class="row">
                                <div class="col-7 col-sm-7 col-md-8 col-lg-8 col-xl-8">
                                    <div class="izquierda">
                                        <p> <b> EXAMPLE</b></p>
                                        <b>0.</b><input type="text" name="e0" style="width: 350px;">
                                    </div>
                                </div>
                                ...
                                <div class="col-5 col-sm-5 col-md-4 col-lg-4 col-xl-4" style="margin: 0px;">
                                    <div>
                                        ...
                                        <!--img src="./EXAVER Pagina 1_files/J.png" class="img-fluid" alt=""-->
                                    ...
                                    <div style="margin-left: 18px">
                                        ...
                                        <div class="row EspacioRespuestas">
                                            <div class="col-6 col-sm-7 col-md-7 col-lg-8 col-xl-8">
                                                <div class="centrado">
                                                    <b> 1.</b><input type="text" name="r1" style="width: 350px;">
                                                </div>
                                            </div>

                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                                <!--img src="./EXAVER Pagina 1_files/A.png" class="img-fluid" alt=""-->
                                                <div class="" style="width: 318px;height: 112px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(A.jpg);background-size: cover;">
                                                        ...
                                                        <div style="margin-left: 50px; padding: 15px;">
                                                            <textarea name="rA" style="width: 205px;"></textarea>
                                        ...
                                        <div class="row EspacioRespuestas">
                                            <div class="col-6 col-sm-7 col-md-7 col-lg-8 col-xl-8">
                                                <div class="centrado">
                                                        ...
                                                        <b>2.</b><input type="text" name="r2" style="width: 350px;">
                                        
                                                </div>
                                            </div>     
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                                <!--img src="./EXAVER Pagina 1_files/B.png" class="img-fluid" alt=""-->
                                                <div class="" style="width: 318px;height: 105px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(B.jpg);background-size: cover;">
                                                        ...
                                                        <div style="margin-left: 60px; padding: 10px;">
                                                            <textarea name="rB" style="width: 205px;"></textarea>
                                                            <!--input type="text" name="rB" style="width: 210px;"-->
                                                        </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row EspacioRespuestas">
                                            <div class="col-6 col-sm-7 col-md-7 col-lg-8 col-xl-8">
                                                <div class="centrado">
                                                    <b>3.</b><input type="text" name="r3" style="width: 350px;">
                                                </div>
                                            </div>
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                                <!--img src="./EXAVER Pagina 1_files/C.png" class="img-fluid" alt=""-->
                                        ...
                                        <div class="row EspacioRespuestas">
                                            <div class="col-6 col-sm-7 col-md-7 col-lg-8 col-xl-8">
                                                <div class="centrado">
                                                    <b>4. </b><input type="text" name="r4" style="width: 350px;">
                                                </div>
                                            </div>

                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                                <!--img src="./EXAVER Pagina 1_files/D.png" class="img-fluid" alt=""-->
                                                <div class="" style="width: 318px;height: 105px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(D.jpg);background-size: cover;"><br>
                                                        ...
                                                        <div style="margin-left: 55px; margin-top: -14px;">
                                                            <textarea name="rD" style="width: 205px;"></textarea>
                                        ...
                                        <div class="row EspacioRespuestas">
                                            <div class="col-6 col-sm-7 col-md-7 col-lg-8 col-xl-8">
                                                <div class="centrado">
                                                    <b>5.</b><input type="text" name="r5" style="width: 350px;">
                                                </div>
                                            </div>
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                                ...
                                                <div class="" style="width: 318px;height: 105px;padding: 20px;margin: 10px auto;box-shadow: 0px 0px 0px 0px grey;background-image: url(E.jpg);background-size: cover;">
                                                        ...
                                                        <div style="margin-left: 55px; padding: 8px;">
                                                            <textarea name="rE" style="width: 205px;"></textarea>
                                        ...
                                        <div class="row EspacioRespuestas">
                                            <div class="col-6 col-sm-7 col-md-7 col-lg-8 col-xl-8">
                                                <div class="centrado">
                                                    <b> 6.</b><input type="text" name="r6" style="width: 350px;">
                                                </div>
                                            </div>
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                        ...
                                        <div class="row EspacioRespuestas">
                                            <div class="col-6 col-sm-7 col-md-7 col-lg-8 col-xl-8">
                                                <div class="centrado">
                                                    <b>7.</b><input type="text" name="r7" style="width: 350px;">
                                                </div>
                                            </div>
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
                                        ...
                                        <div class="row EspacioRespuestas">
                                            <div class="col-6 col-sm-7 col-md-7 col-lg-8 col-xl-8">
                                                <div class="centrado">
                                                    <b>8.</b><input type="text" name="r8" style="width: 350px;">
                                                </div>
                                            </div>
                                            <div class="col-6 col-sm-5 col-md-5 col-lg-4 col-xl-4">
