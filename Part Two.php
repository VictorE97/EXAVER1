        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div style="float: right; margin-top: -10px; margin-right: 10px">
                    <a href="Part Two Ingresar.php"> <button type="button" class="btn btn-warning"><i class="fas fa-pen-square"></i></button></a>
                <?php
                                        $conexion = mysqli_connect('localhost', 'root', '123456', 'exaver');
                                        $sql="select * from exa1_part2";
                                        ...
                                        <a href='Part Two Actualizar.php?idPartTwo=".$mostrar['idPartTwo']."'><button class='btn btn-primary' type='button' data-toggle='modal' data-target='#exampleModal'><i class='fas fa-edit'></i></button></a>

                                        <a href='Eliminar/Eliminar_PartTwo.php?idPartTwo=".$mostrar['idPartTwo']."'> <button type='button' class='btn btn-danger'><i class='far fa-trash-alt'></i></button></a>

                                        </td>";
                                        echo "<tr>";
                                            echo "<td>"; echo "<input type='hidden' name='idPartTwo' value='.$mostrar[0].' />"; echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
                </div> <br><br>      <!--Menu de las respuestas-->
                ...
                <div class="izquierda">
                  ...
                  <div class="row">
                    ...
                    <div class="col-10">
                      ...
                      <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom0_3"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["e0_0"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                    </div>
              ...
              <div style="margin-left: 18px">
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom1_1"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r1_1"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      ...
                      <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom1_3"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r1_2"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom2_1"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r2_1"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      ...
                      <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom2_3"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r2_2"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom3_1"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r3_1"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      ...
                      <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom3_3"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r3_2"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom4_1"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r4_1"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      ...
                      <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom4_3"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r4_2"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom5_1"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r5_1"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      ...
                      <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom5_3"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r5_2"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom6_1"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r6_1"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      ...
                      <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom6_3"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r6_2"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom7_1"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r7_1"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      ...
                      <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom7_3"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r7_2"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                   ...
                   <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom8_1"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r8_1"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      ...
                      <div class="row">
                        <div class="col-2">
                          <p> <b><?php echo $row["nom8_3"]; ?></b> </p>
                        </div>
                        <div class="col-10">
                          <p><?php echo $row["r8_2"]; ?></p>
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
