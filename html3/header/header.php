...
<p><b><span id="horas"><?php echo $horas ?></span> <span id="puntos"> : <span id="minutos"><?php echo $minutos ?></span> <span id="puntos">:</span> <span id="segundos"><?php echo $segundos ?></span> </b></p>
																</div>
