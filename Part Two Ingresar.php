...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
      ...
      <form action="Agregar/Agregar_PartTwo.php" method="POST">
                ...
                <div class="izquierda">
                  ...
                  <div class="row">
                    ...
                    <div class="col-10">
                      ...
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom0_1" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="e0" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      <div class="row">
                        <div class="col-2">
                         <input type="text" name="nom0_2" style="width: 75px;"> 
                        </div>
                        <div class="col-10">
                      ...
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom0_3" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="e0_0" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                    </div>
              ...
              <div class="col-5 col-sm-5 col-md-5 col-lg-5 col-xl-5">
                <div class="derecha">
                  ...
                  <div class="row">
                    ...
                    <div class="col-10">
                      <input type="text" name="er_0" style="width: 350px; margin: 5px">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div style="margin-left: 18px">
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom1_1" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="" name="r1_1" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom1_2" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <p>____________________</p>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom1_3" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r1_2" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom2_1" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r2_1" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom2_2" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <p>____________________</p>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom2_3" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r2_2" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom3_1" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r3_1" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom3_2" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <p>____________________</p>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom3_3" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r3_2" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom4_1" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r4_1" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom4_2" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <p>____________________</p>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom4_3" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r4_2" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom5_1" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r5_1" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom5_2" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <p>____________________</p>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom5_3" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r5_2" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom6_1" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r6_1" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom6_2" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <p>____________________</p>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom6_3" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r6_2" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom7_1" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r7_1" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom7_2" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <p>____________________</p>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom7_3" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r7_2" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-10">
                   ...
                   <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom8_1" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r8_1" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                      <!--opcion-->
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom8_2" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <p>____________________</p>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-2">
                          <input type="text" name="nom8_3" style="width: 75px;">
                        </div>
                        <div class="col-10">
                          <input type="text" name="r8_2" style="width: 350px;">
                        </div>
                      </div>
                      <!--opcion-->
                  </div>
              ...
              <div class="miBordeSencillo2" style="margin-right: 10px">
                <div style="margin: 3px;">
                  ...
                  <div class="row">
                    ...
                    <div class="col-10">
                      <p><input type="text" name="rA" style="width: 350px;"></p>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    ...
                    <div class="col-10">
                      <p><input type="text" name="rB" style="width: 350px;"></p>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    ...
                    <div class="col-10">
                      <p> <input type="text" name="rC" style="width: 350px;"></p>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    ...
                    <div class="col-10">
                      <p><input type="text" name="rD" style="width: 350px;"></p>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    ...
                    <div class="col-10">
                      <p><input type="text" name="rE" style="width: 350px;"></p>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    ...
                    <div class="col-10">
                      <p><input type="text" name="rF" style="width: 350px;"></p>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    ...
                    <div class="col-10">
                      <p><input type="text" name="rG" style="width: 350px;"></p>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    ...
                    <div class="col-10">
                      <p><input type="text" name="rH" style="width: 350px;"></p>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    ...
                    <div class="col-10">
                      <p><input type="text" name="rI" style="width: 350px;">
                    </p></div>
                  </div>
                  <br>
                  <div class="row">
                    ...
                    <div class="col-10">
                      <p> <input type="text" name="rJ" style="width: 350px;">
                      </p>
                    </div>
                  </div>
                  <!--opciones--> 
